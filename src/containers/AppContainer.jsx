...
const grid = [
  ...
  [createToken('!', 'FUNCTION', 4, 'RIGHT'), createToken('7'), createToken('8'), createToken('9'), createToken('\u00D7', 'OPERATOR', 3, 'LEFT')],
  [createToken('\u221A', 'FUNCTION', 4, 'RIGHT'), createToken('4'), createToken('5'), createToken('6'), createToken('/', 'OPERATOR', 3, 'LEFT')],
